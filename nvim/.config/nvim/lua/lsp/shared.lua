...
M.on_attach = function(_, bufnr)
    ...
    vim.keymap.set("n", "gri",function()  vim.lsp.buf.rename() end, With_desc("LSP: Go to implementation", opts))
    vim.keymap.set("n", "grt",function()  vim.lsp.buf.rename() end, With_desc("LSP: Jump to type definition", opts))
    vim.keymap.set("n", "grx",function()  vim.lsp.buf.rename() end, With_desc("LSP: Run codelens", opts))
